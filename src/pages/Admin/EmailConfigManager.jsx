...
const EmailConfigManager = () => {
  ...
  if (!isMainAdmin() && !hasPermission("email.config")) {
    ...
    <div className="max-w-4xl">
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <p className="text-gray-600 mb-6">
          Configure email settings for automated receipts and notifications
          using Resend.
        </p>
        ...
        <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          <p className="text-sm text-green-800">
            <strong>✅ Email automation is now active!</strong> Configuration is
            stored in Firestore. When you click "Send Test", your settings will
            be automatically saved before sending.
          </p>
        </div>
      </div>
    </div>
