...
import Monthly1 from "@/assets/Sevas/monthly.png";
...
const Monthly = () => {
  return (
    ...
    >
      ...
      <div className=" h-auto  2xl:w-3/4 3xl:w-3/4 xl:w-3/4 lg:w-3/4 md:tw-3/4 sm:w-5/6 xs:w-5/6 2xs:w-5/6 overflow-hidden mb-[4%]">
        <img src={Monthly1} className="h-full w-full"></img>
      </div>
    </Container>
  );
};
